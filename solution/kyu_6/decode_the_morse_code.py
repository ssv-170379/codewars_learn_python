...
def decodeMorse(morse_code):
    # long form
    # decoded_words = []
    # for m_word in morse_code.strip().split('   '):  # clean-up leading/trailing spaces and split to words, iterate over words
    #     decoded_words.append(''.join(MORSE_CODE[m_character] for m_character in m_word.split(' ')))  # decode each word
    # return ' '.join(decoded_words)  # compose decoded words to string and return
